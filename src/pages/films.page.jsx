...
import { Loader, MainLayout, SingleFilmLayout } from "../components";
import { Form, Card, ListGroup, ListGroupItem, Row, Col, Badge } from "react-bootstrap";
			...
			<div className="">
				...
				<Form>
					<Form.Group className="mb-3" controlId="searchDirector">
						...
						<Form.Select value={searchDirector} onChange={(e) => setSearchDirector(e.target.value)}>
